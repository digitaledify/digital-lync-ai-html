...
const Course = () => {
  ...
  const coursesName = params?.coursesName as string;
  const Fundamentals = courseData?.filter((i) => i?.course === coursesName)?.[0];

  return (
    <>
      {/* <Heading title={Fundamentals?.headerTitle} rating={Fundamentals?.rating} liveProjects={Fundamentals?.liveProjects} duration={Fundamentals?.duration} /> */}
