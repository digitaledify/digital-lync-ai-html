...
import figma from "../assets/Course/fig.png";
import autodesk from "../assets/Course/desk.png";
import notion from "../assets/Course/not.png";
import autocad from "../assets/Course/aut.png";
...
export const courseData = [
  {
    pageTitle: "Best Java Training Real-Time Projects | Get Job 2025",
    pageDescription: "Master Java programming with Digital Lync's expert-led training. Learn core and advanced Java concepts through real-time projects. Enroll now.",
    ...
    courseTitle: "Why Java Training With Digital Lync?",
  ...
  {
    pageTitle: "Best UI/UX Design Training with Real Projects | Get Job 2025",
    pageDescription: "Learn UI/UX design principles with Digital Lync. Expert mentors, flexible learning, and career support. Enroll now to become a UI/UX designer.",
  ...
  {
    pageTitle: "Best Python Training with Real-Time Projects | Get Job 2025",
    pageDescription: "Learn Python programming from basics to advanced with Digital Lync. Work on real-time projects and gain industry-recognized certification. Enroll now.",
    ...
    courseTitle: "Why Python Training With Digital Lync?",
  ...
  {
    pageTitle: "React JS Training & Certification Course | Get Job 2025",
    pageDescription: "Learn to build dynamic web applications using React. Real-time projects, expert trainers, flexible learning, and 100% placement assistance. Enroll now!",
    ...
    courseTitle: "Why React JS Training With Digital Lync?",
  ...
  {
    pageTitle: "Full-Stack Developer with Projects | Get Job 2025",
    pageDescription: "Master Full-Stack  development with Digital Lync's comprehensive program. Learn frontend and backend technologies through real-time projects.",
  ...
  {
    pageTitle: " Business Analyst Training Course | Get Job 2025",
    pageDescription: "Learn BA tools, techniques, and methodologies. Real-time projects, industry experts, flexible learning, and 100% placement support. Enroll today!",
    ...
    courseTitle: "Why Business Analysis With Digital Lync?",
  ...
  {
    pageTitle: "  Testing Course | Manual & Automation | Get Job 2025",
    pageDescription: "Learn manual and automation testing tools like Selenium. Real-time projects, expert instructors, flexible schedules, and 100% placement assistance.",
    ...
    courseTitle: "Why Software Testing Training With Digital Lync?",
  ...
  {
    pageTitle: "  Best DevOps Training with Hands-On Labs | Get Job 2025",
    pageDescription: "Master DevOps tools and practices with Digital Lync's training. Learn CI/CD, Docker, Kubernetes, and more. Hands-on labs and projects. Enroll today.",
    ...
    courseTitle: "Why DevOps Program With Digital Lync?",
  ...
  {
    pageTitle: "Azure DevOps Training & Certification Course | Get Job 2025",
    pageDescription: "Master Azure DevOps services, CI/CD pipelines, and automation with real-time projects.  100% placement assistance in Hyderabad, Bangalore. Enroll now!",
    ...
    headerImage: azdev,
    courseTitle: "Why Azure DevOps Program With Digital Lync?",
  ...
  {
    pageTitle: "Best AWS Cloud Training Certification Course | Get Job 2025",
    pageDescription: "Become an AWS Certified Cloud Engineer with Digital Lync's training. Learn AWS services, architecture, and deployment. Enroll now for cloud career success.",
    ...
    courseTitle: "Why AWS Training With Digital Lync?",
  ...
  {
    pageTitle: "Azure Cloud Training & Certification Course | Get Job 2025",
    pageDescription: "Learn Azure cloud services, architecture, and deployment with hands-on projects. 100% placement assistance in Hyderabad, Bangalore. Enroll today!",
    course: "azure-cloud-training-certification",
    headerTitle: "Azure Cloud Training & Certification",
    courseHeader: ["DevOps Engineer", "Azure DevOps Engineer", "Azure DevOps Consultant", "DevOps Architect", "System Administrator"],
    headerImage: azdev,
    courseTitle: "Why Azure Training With Digital Lync?",
  ...
  {
    pageTitle: "Salesforce Training in Hyderabad, India, Realtime Online & ClassRoom",
    pageDescription: "Best SalesForce Training Institute in Hyderabad, India. Interviews & Job Support,100% Placement Assistance & Top Rated",
    course: "sales-force-training-certification",
    headerTitle: "Salesforce Training",
    courseHeader: ["ReactJS Developer", "UI Developer", "Front End Developer", "Front End Engineer", "Full Stack Engineer"],
    headerImage: slacebanner,
    courseTitle: "Why Salesforce Training With Digital Lync?",
  ...
  {
    pageTitle: "Azure Data Engineering Training & Certification | Get Job 2025",
    pageDescription: "Learn data integration, storage, processing, and security in Azure. Real-time projects, Expert trainers, and 100% placement support. Enroll now!",
    ...
    courseTitle: "Why Azure Data Engineering With Digital Lync?",
  ...
  {
    pageTitle: "AWS Data Engineering Training & Certification| Get Job 2025",
    pageDescription: "Learn about AWS data services, ETL processes, and data pipelines. Real-time projects, flexible learning, and 100% placement assistance. Enroll today!",
    ...
    headerImage: aws_eng,
    courseTitle: "Why AWS Data Engineering With Digital Lync?",
  ...
  {
    pageTitle: "GCP Data Engineering Training Certification | Get Job 2025",
    pageDescription: "Learn Google Cloud data services, data pipelines, and analytics. Hands-on projects,  and 100% placement support. Enroll Now!",
    ...
    headerImage: gcp_eng,
    courseTitle: "Why GCP Data Engineering With Digital Lync?",
  ...
  {
    pageTitle: "#1 Artificial Intelligence (AI) Training | Get Job 2025",
    pageDescription: "Learn machine learning, deep learning, computer vision, and NLP. Real-time projects, expert instructors, and 100% placement support. Enroll now",
  ...
  {
    pageTitle: "Data Science Course Training in Hyderabad, Realtime Online & ClassRoom",
    pageDescription: "Best Full Stack Masters Training Institute in Hyderabad, India. Interviews & Job Support,100% Placement Assistance & Top Rated",
  ...
  {
    pageTitle: "#1 Power BI Training & Certification Course | Get Job 2025",
    pageDescription: "Expert-led training, real-time projects, flexible schedules, and 100% placement assistance. Enroll today to advance your analytics career!",
    ...
    headerImage: babanner,
    courseTitle: "Why Azure Power Bi Training With Digital Lync?",
  ...
  {
    pageTitle: "#1 Data Analysis Training & Certification Course | Get Job 2025",
    pageDescription: "Expert-led training, real-time projects, flexible schedules, and 100% placement assistance. Enroll today to advance your analytics career!",
    course: "data-analysis-training-certification",
    headerTitle: "#1 Data Analyst Course with AI",
    courseHeader: ["Data Analyst", "Business Intelligence Analyst (BI Analyst)", "Power BI Developer/Analyst", "Financial Analyst", "Marketing Analyst",],
    headerImage: babanner,
    courseTitle: "Why Data Analysis Training With Digital Lync?",
    title: "Power Bi Course Curriculum",
    subTitle: "It stretches your mind, think better and create even better.",
    courseList: [
      "Fundamentals of IT",
      "Data Analysis Basics",
      "Advanced Data Analysis (DAX)",
      "Advanced Data Analysis (DAX)",
      "SQL for Data Analysis",
      "Python for Data Analysis",
      "Data Cloud & DevOps",
    ...
    accordionData: [
      ...
      {
        maintitle: "Basic Data Analysis Course",
        subdata: [
          {
            module: "Module 1",
          ...
          {
            module: "Module 4",
            title: "Grouping and Hierarchies in Data Analysis",
            topics: [
              {
                description: [
                  "Implementing Grouping and Binning in Reports",
          ...
          {
            module: "Module 6",
            title: "Data Analysis Service (Cloud) Basics",
            topics: [
              {
                description: [
      ...
      {
        maintitle: "Advanced Data Analysis Course",
        subdata: [
          {
            module: "Module 1",
            title: "Advanced Report Design and Visualization",
          ...
          {
            module: "Module 3",
            title: "Advanced Data Analysis Cloud Features",
            topics: [
              {
                description: [
                  "Configuring and Managing Gateways for Data Refresh",
      ...
      {
        maintitle: "AI-Powered Data Analysis",
        subdata: [
          {
            module: "Module 1",
            title: "Introduction to Generative AI and AI Agents",
            topics: [
              {
                description: [
          ...
          {
            module: "Module 3",
            title: "AI Agents: Design, Architecture, and Implementation",
            topics: [
              {
                description: [
          ...
          {
            module: "Module 4",
            title: "GenAI and AI Agents for Data Analysis Workflows",
            topics: [
              {
                description: [
            ...
            topics: [
              {
                description: [
                  ...
                  "ICase studies and practical examples of GenAI and AI agents in different industries.",
  ...
  {
    pageTitle: "Creative Interior Design Course  | Get Job 2025",
    pageDescription: "Best Interior Design Course in Hyderabad, India. Online & ClassRoom with Real time projects, Interviews & Job Support,100% Placement Assistance & Top Rated",
    course: "interior-design-course-certification",
    headerTitle: " Interior Design Course",
    courseHeader: ["Interior Design", "UI/UX", "CAD Designer", "Adobe Designer", "Digital Marketing",],
    headerImage: azure_eng,
    courseTitle: "Why Interior Design Training With Digital Lync?",
    title: "Interior Design Course Curriculum",
    subTitle: "It stretches your mind, think better and create even better.",
    courseList: [
      "Core Foundations of Interior Design",
      "Technical Skills in Interior Design",
      "Advanced 3D Modeling and Rendering",
    ],
    accordionData: [
      {
        maintitle: "Core Foundations of Interior Design",
        subdata: [
          {
            module: "Module 1",
            ...
            topics: [
              {
                description: [
                  "Basic Operations and Interface Navigation",
                  "Precision Drawing and Modification Techniques",
                  "Layer Management and Effective Block Usage",
                ],
              },
          ...
          {
            module: "Module 4",
            title: "Materials in Interior Design",
            topics: [
              {
                description: [
                  "Basic Operations and Interface Navigation",
      ...
      {
        maintitle: "Technical Skills in Interior Design",
        subdata: [
          {
            module: "Module 1",
          ...
          {
            module: "Module 2",
            title: "Vaastu Principles in Design",
            topics: [
              {
                description: [
                  "Introduction to Vaastu Concepts",
                  "Integrating Vaastu in Modern Design Frameworks",
                ],
              },
            ],
          },
            ...
            topics: [
              {
                description: [
                  ...
                  "Modifier and Editing Command Mastery",
                  "Scale and Layout Planning",
                ],
              },
            ],
          },
          {
            module: "Module 4",
            title: "Professional Planning Skills",
            topics: [
              {
                description: [
                  "Application of Vaastu in Professional Plans",
                  "Specialized Layout Development: Kitchens, Elevations",
          ...
          },
          {
            ...
            topics: [
              {
                description: [
                  "Effective 2D Rendering Techniques",
                  "Communicating Design Ideas Visually",
                ],
              },
            ],
          },
      ...
      {
        maintitle: "Advanced 3D Modeling and Rendering",
        subdata: [
          {
            module: "Module 1",
            ...
            topics: [
              {
                description: [
                  ...
                  "Transition from 2D to 3D Models",
                ],
              },
            ],
          },
          {
            module: "Module 2",
            title: "Understanding SketchUp Mechanics",
            topics: [
              {
                description: [
                  "Mastering Groups and Components",
                  "Extrusion Techniques for Realistic Models",
                ],
              },
            ],
          },
          {
            module: "Module 3",
            title: "Texturization and Material Application",
            topics: [
              {
                description: [
                  "Applying Realism through Textures",
                  "Material Selection for Depth and Authenticity",
                ],
              },
            ],
          },
          {
            module: "Module 4",
            title: "Dynamic Design Visualization",
            topics: [
              {
                description: [
                  "Advanced Modeling: Creating Detailed Room Layouts",
                  "Utilizing Vray for SketchUp",
                ],
              },
            ],
          },
          {
            module: "Module 5",
            title: "Mastery of Rendering with Vray",
            topics: [
              {
                description: [
                  "Techniques for Photorealistic Renders",
                  "Enhancing Visual Presentation through Lighting and Materials",
                ],
              },
            ],
          },
  ...
  {
    pageTitle: "Learn Fashion Design Course from Industry Experts  | Get Job 2025",
    pageDescription: "Best Fashion Design Course in Hyderabad, India. Online & ClassRoom with Real time projects, Interviews & Job Support,100% Placement Assistance & Top Rated",
    course: "fashion-design-course-certification",
    headerTitle: " Fashion Design Course",
    courseHeader: ["Fashion Design", "UI/UX", "CAD Designer", "Adobe Designer", "Digital Marketing",],
    headerImage: babanner,
    courseTitle: "Why Fashion Design Training With Digital Lync?",
    title: "Fashion Design Course Curriculum",
    subTitle: "It stretches your mind, think better and create even better.",
    courseList: [
      "Core Foundations of Fashion Design",
        ...
        subdata: [
          {
            ...
            topics: [
              {
                name: "1. Contemporary Fashion Vocabulary :",
                description: [
                  "Unpack the latest jargon and terminologies shaping today's fashion world.",
                ],
              },
              {
                name: "2. Fundamentals of Design  :",
                description: [
                  "Dive into modern principles and elements that influence design aesthetics and functionality.",
                ],
              },
              {
                name: "3. Trend Forecasting and Fashion Cycles :",
                description: [
                  "Analyze how trends emerge, evolve, and recede in the fast-paced fashion industry.",
                ],
              },
            ],
          },
          {
            module: "Module 2",
            title: "Fashion Art and Digital Illustration",
            topics: [
              {
                name: "1. Innovative Sketching Techniques :",
                description: [
                  "Merge traditional drawing with contemporary fashion sketching.",
                ],
              },
              {
                name: "2. Mastering Digital Design Tools :",
                description: [
                  "Employ leading software like Adobe Illustrator and Photoshop for fashion illustration.",
                ],
              },
              {
                name: "3. Color Mastery :",
                description: [
                  "Explore advanced color theory, applications, and the psychological effects of color in fashion.",
                ],
              },
            ],
          },
          {
            module: "Module 3",
            title: "Textiles, Materials, and Sustainability",
            topics: [
              {
                name: "1. Next-Gen Textiles :",
                description: [
                  "Detailed study of contemporary fabrics, their sourcing, and eco-friendly alternatives.",
                ],
              },
              {
                name: "2. Pattern Engineering and Textile Innovation :",
                description: [
                  "From modern patterns to sustainable handloom techniques.",
                ],
              },
              {
                name: "3. Creative Textile Embellishments :",
                description: [
                  "Learn cutting-edge fabric manipulation, digital printing, and eco-conscious embellishment techniques.",
                ],
              },
            ],
          },
          {
            module: "Module 4",
            title: "Advanced Sewing and Garment Creation",
            topics: [
              {
                name: "1. Precision Sewing Techniques  :",
                description: [
                  "Mastering garment assembly focusing on innovation and quality.",
                ],
              },
              {
                name: "2. Evolved Pattern Drafting :",
                description: [
                  "Advanced strategies in pattern making and digital drafting for achieving perfect fits.",
                ],
              },
              {
                name: "3. Quality Assurance in Fashion :",
                description: [
                  "Enforcing high standards of finishing and quality control in garment production",
                ],
              },
            ],
          },
          {
            module: "Module 5",
            title: "Fashion Styling and Iconography",
            topics: [
              {
                name: "1. Defining Contemporary Fashion  :",
                description: [
                  "Overview of current fashion genres and their impact on culture.",
                ],
              },
              {
                name: "2. Visual Style Narratives  :",
                description: [
                  "Examining iconic styles through history and their influence on today's fashion.",
                ],
              },
              {
                name: "3. Trendsetting and Forecasting :",
                description: [
                  "Methods for predicting the future directions of fashion styling.",
                ],
              },
            ],
          },
          {
            module: "Module 6",
            title: "Digital Marketing and Fashion Branding",
            topics: [
              {
                name: "1. Strategic Fashion Communication  :",
                description: [
                  "Leveraging social media, digital marketing, and storytelling for brand identity.",
                ],
              },
              {
                name: "2. Innovative Brand Creation :",
                description: [
                  "Insights into launching and managing a fashion brand in the digital age.",
                ],
              },
              {
                name: "3. Revolutionizing Visual Merchandising :",
                description: [
                  "Implementing AR/VR and digital tools for immersive retail experiences.",
                ],
              },
            ],
          },
          {
            module: "Module 7",
            title: "Portfolio Design and Creative Direction",
            topics: [
              {
                name: "1. Dynamic Fashion Portfolios   :",
                description: [
                  "Building impactful portfolios that showcase innovation and personal style.",
                ],
              },
              {
                name: "2. Process and Critique :",
                description: [
                  "A structured approach to developing, refining, and presenting a professional portfolio.",
                ],
              },
              {
                name: "3. Creative Direction Workshop :",
                description: [
                  "Cultivating a signature aesthetic and visionary direction for fashion projects.",
                ],
              },
            ],
          },
          {
            module: "Module 8",
            title: "Ethical Fashion and Environmental Stewardship",
            topics: [
              {
                name: "1. Eco-Fashion Movements :",
                description: [
                  "Exploring the environmental impact of fashion and sustainable practices to minimize harm.",
                ],
              },
              {
                name: "2. Principles of Sustainable Design :",
                description: [
                  "Adopting ethical design practices from sourcing to production.",
                ],
              },
              {
                name: "3. Circular Fashion Economy :",
                description: [
                  "Promoting upcycling, recycling, and sustainable lifecycle management for fashion items.",
                ],
              },
            ],
          },
  ...
  {
    pageTitle: "Learn UI/UX Design from Industry Experts  | Get Job 2025",
    pageDescription: "Best UI/UX Design Course in Hyderabad, India. Online & ClassRoom with Real time projects, Interviews & Job Support,100% Placement Assistance & Top Rated",
    course: "uiux-design-course-certification",
    headerTitle: " UI/UX Design Course",
    courseHeader: ["UI/UX Design", "UI", "CAD Designer", "Adobe Designer", "Digital Marketing",],
    headerImage: uiuxbanner,
    courseTitle: "Why UI/UX Design Training With Digital Lync?",
    title: "UI/UX Design Course Curriculum",
    subTitle: "It stretches your mind, think better and create even better.",
    courseList: [
      "Core Foundations of UI/UX Design",
      "Technical Skills in UI/UX Design",
    ],
    accordionData: [
      {
        maintitle: "UI/UX Design Course",
            ...
            topics: [
              {
                description: [
                  "Building Tangible Solutions : Understanding rapid prototyping techniques.",
                  "Tools and Materials : Learn about low-fidelity vs. high-fidelity prototypes.",
                  "Iterative Process : Emphasize the importance of iteration and feedback in prototyping.",
                ],
              },
            ],
  ...
  {
    pageTitle: "Learn Graphic Design from Industry Experts  | Get Job 2025",
    pageDescription: "Best Graphic Design Course in Hyderabad, India. Online & ClassRoom with Real time projects, Interviews & Job Support,100% Placement Assistance & Top Rated",
    course: "graphic-design-course-certification",
    headerTitle: " Graphic Design Course",
    courseHeader: ["Graphic Design", "Graphic", "CAD Designer", "Adobe Designer", "Digital Marketing",],
    headerImage: databanner,
    courseTitle: "Why Graphic Design Training With Digital Lync?",
    title: "Graphic Design Course Curriculum",
    subTitle: "It stretches your mind, think better and create even better.",
    courseList: [
    ...
    accordionData: [
      {
        maintitle: "Adobe Photoshop - Digital Imaging Mastery",
        subdata: [
          {
            module: "Module 1",
            ...
            topics: [
              {
                description: [
                  ...
                  "Setting Up a Project: Canvas, Resolution, and Color Modes",
                ],
              },
            ...
            topics: [
              {
                description: [
                  ...
                  "Layers Deep Dive: Adjustment Layers, Blend Modes, Smart Objects",
                  "Photo Retouching and Restoration Techniques",
                ],
              },
            ],
          },
          {
            module: "Module 3",
            title: "Creative Design and Composition",
            topics: [
              {
                description: [
                  "Creating Engaging Compositions and Layouts",
                  "Typography in Photoshop: Advanced Text Effects",
                  "Utilizing Brushes and Patterns for Artistic Flair",
                ],
              },
          ...
          {
            module: "Module 4",
            title: "Real-World Graphic Design Projects",
            topics: [
              {
                description: [
                  "Logo Design and Branding Elements",
                  "Marketing Collateral: Flyers, Brochures, and Posters",
          ...
          {
            module: "Module 5",
            title: "Photoshop for Digital Art",
            topics: [
              {
                description: [
      ...
      {
        maintitle: "Adobe After Effects - Motion Graphics & Visual Effects",
        subdata: [
          {
            module: "Module 1",
            ...
            topics: [
              {
                description: [
                  "Overview of Interface and Workflow",
          ...
          },
          {
            ...
            topics: [
              {
                description: [
                  "Creating Complex Animations Using the Graph Editor",
                  "Motion Tracking and Compositing",
                  "Using 3D Layers and Camera Movement",
                ],
              },
            ],
          },
            ...
            topics: [
              {
                description: [
                  ...
                  "Particle Effects for Realistic Simulations",
          ...
          {
            module: "Module 4",
            title: "Motion Graphics for Branding and Advertising",
            topics: [
              {
                description: [
                  "Designing Animated Logos and Lower Thirds",
          ...
          {
            module: "Module 5",
            title: "After Effects for Filmmakers",
            topics: [
              {
                description: [
                  "Title Sequence Design",
                  "VFX for Independent Films",
                  "Exporting Projects for Different Platforms and Uses",
                ],
              },
            ],
          },
      ...
      {
        maintitle: "Adobe Premiere Pro - Video Editing Essentials",
        subdata: [
          {
            module: "Module 1",
            ...
            topics: [
              {
                description: [
                  "Understanding the Workspace and Workflow",
                  "Importing and Organizing Media",
                  "Basic Video Editing: Cutting, Trimming, and Sequencing",
                ],
              },
            ...
            topics: [
              {
                description: [
                  ...
                  "Audio Editing and Mixing within Premiere Pro",
                ],
              },
            ],
          },
          {
            module: "Module 3",
            title: "Integrating with Other Adobe Applications",
            topics: [
              {
                description: [
                  "Dynamic Link with After Effects and Photoshop",
                  "Using Adobe Audition for Advanced Audio Editing",
                  "Incorporating Adobe Illustrator and Animate Assets",
                ],
              },
            ],
          },
          {
            ...
            topics: [
              {
                description: [
                  "Narrative Development in Editing",
                  "Creative Transitions and Effects",
                  "Building Tension and Pace with Editing Techniques",
                ],
              },
            ],
          },
          {
            module: "Module 5",
            title: "Exporting and Distribution",
            topics: [
              {
                description: [
                  "Export Settings and Formats for Different Platforms",
                  "Utilizing Adobe Media Encoder for Batch Exports",
                  "Best Practices for Online and Broadcast Delivery",
                ],
              },
            ],
          },
  ...
  {
    pageTitle: "Spoken English from Industry Experts  | Get Job 2025",
    pageDescription: "Best Spoken English Course in Hyderabad, India. Online & ClassRoom with Real time projects, Interviews & Job Support,100% Placement Assistance & Top Rated",
    course: "spoken-english-course-certification",
    headerTitle: " Spoken English Course",
    courseHeader: ["Spoken English", "Grammer", "English Tutor", "Expert ", "Public Speaker",],
    headerImage: pythonbanr,
    courseTitle: "Why Spoken English  Training With Digital Lync?",
    title: "Spoken English  Course Curriculum",
    subTitle: "It stretches your mind, think better and create even better.",
    courseList: [
      "Expert Instructors",
    ...
    accordionData: [
      { maintitle: "Spoken English  Topics",
        subdata: [
          {
            module: "Module 1",
            ...
            topics: [
              {
                name: "Objective: Understanding the importance of spoken English and setting learning goals.",
              },
              {
                name: "Topics Covered:",
                description: [
              ...
              },
              {
                ...
                description: [
                  ...
                  "Self-assessment of current English speaking level.",
          ...
          },
          {
            ...
            topics: [
              {
                name: "Objective: Building a strong foundation in grammar and vocabulary.",
              },
              {
                name: "Topics Covered:",
                description: [
          ...
          },
          {
            ...
            topics: [
              {
                name: "Objective: Improving pronunciation and understanding phonetic elements.",
              },
              {
                name: "Topics Covered:",
                description: [
              ...
              },
              {
                ...
                description: [
                  ...
                  "Phonetic exercises.",
                  "Recording and playback of speech for self-correction."],
              },
          ...
          },
          {
            ...
            topics: [
              {
                name: "Objective: Developing conversational fluency and natural speaking habits.",
              },
              {
                name: "Topics Covered:",
                description: [
                  "Greeting and introducing oneself.",
                  "Everyday conversations (ordering food, asking for directions, etc.).",
              ...
              },
              {
                ...
                description: [
                  ...
                  "Conversation practice in pairs or groups.",
                  "Dialogues and skits."],
              },
          ...
          },
          {
            ...
            topics: [
              {
                name: "Enhancing listening skills and appropriate responses.",
              },
              {
                name: "Topics Covered:",
                description: [
              ...
              },
              {
                ...
                description: [
                  ...
                  "Practice responding to audio clips."],
              },
          ...
          },
          {
            ...
            topics: [
              {
                name: "Objective: Boosting confidence in speaking English publicly.",
              },
              {
                name: "Topics Covered:",
                description: [
          ...
          },
          {
            ...
            topics: [
              {
                name: "Objective: Mastering more complex grammar and expanding vocabulary.",
              },
              {
                name: "Topics Covered:",
                description: [
              ...
              },
              {
                ...
                description: [
                  ...
                  "Practical application through writing and speaking exercises."],
              },
          ...
          },
          {
            ...
            topics: [
              {
                name: "Objective:  Achieving fluency and coherence in speech.",
              },
              {
                name: "Topics Covered:",
                description: [
              ...
              },
              {
                ...
                description: [
                  ...
                  "Extensive speaking practice on various topics."],
              },
          ...
          },
          {
            ...
            topics: [
              {
                name: "Objective: Preparing for job interviews and professional conversations.",
              },
              {
                name: "Topics Covered:",
                description: [
              ...
              },
              {
                ...
                description: [
                  ...
                  "Feedback sessions on interview performances."],
              },
          ...
          },
          {
            ...
            topics: [
              {
                name: "Objective: Developing skills for giving effective presentations.",
              },
              {
                name: "Topics Covered:",
                description: [
              ...
              },
              {
                ...
                description: [
                  ...
                  "Practice sessions with different types of audiences."],
              },
          ...
          },
          {
            ...
            topics: [
              {
                name: "Objective: Understanding social and cultural nuances in spoken English.",
              },
              {
                name: "Topics Covered:",
                description: [
          ...
          },
          {
            ...
            topics: [
              {
                name: "Objective: Encouraging ongoing practice and improvement.",
              },
              {
                name: "Topics Covered:",
                description: [
              ...
              },
              {
                ...
                description: [
                  ...
                  "Introducing online resources and tools.",
                  "Encouragement of language practice clubs or groups."],
              },
...
export const programsData = [
  {
    pageTitle: "Full-Stack Java Developer with Projects |Get Job 2025",
    pageDescription: "Master Full-Stack Java development with Digital Lync's comprehensive program. Learn frontend and backend technologies through real-time projects.",
    ...
    headerImage: java,
    courseTitle: "Why Job Ready Program FullStack Java With Digital Lync?",
  ...
  {
    pageTitle: "Full-Stack Python Developer Training with Django | Get Job 2025",
    pageDescription: "Join Digital Lync's Full-Stack Python program to master frontend and backend development using Python frameworks like Django and Flask.",
  ...
  {
    pageTitle: "Best Full-Stack MERN Developer Training | Get Job 2025",
    pageDescription: "Become a proficient MERN stack developer with Digital Lync. Learn MongoDB, Express, React, and Node.js through hands-on projects. Enroll now.",
  ...
  {
    pageTitle: "Full-Stack AI & Data Science Program | Get Job 2025",
    pageDescription: "Master AI and Data Science with Digital Lync's full-stack program. Learn machine learning, deep learning, NLP, and more. Work on real-world projects.",
  ...
  {
    pageTitle: "Multi-Cloud DevOps Program | AWS, Azure, GCP | Get Job 2025",
    pageDescription: "Learn DevOps across AWS, Azure, and GCP with Digital Lync's multi-cloud program. Gain expertise in cloud platforms and DevOps tools. Enroll now",
    ...
    headerImage: java,
    courseTitle: "Why Multi-Cloud DevOps With Digital Lync?",
  ...
  {
    pageTitle: "Multi-Cloud Data Engineer | Build Data on AWS, Azure, GCP",
    pageDescription: "Become a data engineer proficient in AWS, Azure, and GCP with Digital Lync. Learn to build and manage data pipelines across cloud platforms. Enroll now.",
    course: "multi-cloud-data-engineering-training",
    headerTitle: "Advance Your Career with Multi-Cloud Data Engineering Skills",
    courseHeader: ["Azure Data Engineer", "Azure Data Architect", "Azure Data Scientist", "Azure AI Engineer", "Azure Solutions Architect"],
    headerImage: java,
    courseTitle: "Why Multi-Cloud Data Engineering With Digital Lync?",
  ...
  {
    pageTitle: "Data Analyst Program | SQL, Power BI, Python | Get Job 2025",
    pageDescription: "Join Digital Lync's Data Analyst program to master Excel, SQL, Power BI, and Python. Gain practical skills with real-world data projects. Enroll now.",
    course: "data-analyst-training",
    headerTitle: "Become a Skilled Data Analyst with Comprehensive Training",
    courseHeader: ["Power Bi Engineer", "Power Bi Architect", "Technology Consultant ReactJs", "Systems Engineer", "System Administrator"],
    headerImage: java,
    courseTitle: "Why AI Data Analyst Training With Digital Lync?",
...
export const servicesData = [
  {
    pageTitle: "Classroom Training with Real-Time Projects | Digital Lync",
    pageDescription: "Join Digital Lync's classroom training programs for hands-on learning with real-time projects. Enroll now and boost your career.",
    course: "class-training",
    pageName: "Class Room Training",
    headerImage: classTraining,
    imagePosition: "br",
    boldDescription: "Welcome to Digital Lync's Classroom Training — ",
    description:
  ...
  {
    pageTitle: "Online Training with Real-Time Projects | Digital Lync",
    pageDescription: "Join Digital Lync's online training programs for hands-on learning with real-time projects. Enroll now and boost your career.",
    course: "online-training",
    pageName: "Online Training",
    headerImage: onlineTraining,
    imagePosition: "bl",
    boldDescription: "Welcome to Digital Lync's Online Training — ",
    description:
  ...
  {
    pageTitle: "Weekend Training with Real-Time Projects | Digital Lync",
    pageDescription: "Join Digital Lync's Weekend training programs for hands-on learning with real-time projects. Enroll now and boost your career.",
    course: "weekend-training",
    pageName: "Weekend Training",
    headerImage: weekendTraining,
    imagePosition: "rl",
    boldDescription: "Welcome to Digital Lync's Weekend Training — ",
    description:
  ...
  {
    pageTitle: "Corporate Training with Real-Time Projects | Digital Lync",
    pageDescription: "Join Digital Lync's Corporate training programs for hands-on learning with real-time projects. Enroll now and boost your career.",
    course: "corporate-training",
    pageName: "Corporate Training",
    headerImage: corporateTraining,
    imagePosition: "tr",
    boldDescription: "Welcome to Digital Lync's Corporate Training — ",
    description:
  ...
  {
    pageTitle: "One-To-One Training with Real-Time Projects | Digital Lync",
    pageDescription: "Join Digital Lync's One-To-One training programs for hands-on learning with real-time projects. Enroll now and boost your career.",
