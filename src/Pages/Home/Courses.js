...
const Courses = ({ title }) => {
    ...
    const CourseData = [
        ...
        },
        {
            ...
            liveProjects: "5 Live Projects",
            rating: "4.8/5",
            description: "Testing training covers software quality assurance, covering various testing methodologies to ensure software reliability."
        },
        {
        ...
        },
        {
            ...
            liveProjects: "5 Live Projects",
            rating: "4.8/5",
            description: "GCP Data Engineering on both front-end and back-end development, enabling them to create complete web applications."
        },
