...
const HelpBox = () => {
    ...
    return (
        <div className="fixed z-50 justify-items-end bottom-24 right-5">
            ...
            {isOpen && (
                <div className="w-[335px] h-[130px] bg-[#fff] border-b border-b-[#e2dfdf] shadow-lg rounded-[30px] mb-4">
                    ...
                    <div className="pl-[10%] pr-[5%] py-[8%] text-[12px]">
                        <a href="tel:+916304982304" className="text-2xl font-normal text-black">+91 6304982304</a>
                    </div>
                </div>
            )}
            {/* Floating Button */}
            <button
                onClick={toggleBox}
                className="flex items-center justify-center rounded-tl-[34px] pt-[7px] pb-2.5 px-2.5 rounded-br-[34px] rounded-tr-[34px] rounded-bl-[8px] w-[60px] h-[60px] transition duration-300 bg-[#5301c7] shadow-lg hover:bg-pink-700"
            >
                {isOpen ? (
